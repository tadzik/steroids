...
BLIB_COMPILED = $(BLIB)/lib/Steroids.moarvm $(BLIB)/lib/Steroids/SDL.moarvm $(BLIB)/lib/Steroids/Spritesheet.moarvm $(BLIB)/lib/Steroids/Entity.moarvm $(BLIB)/lib/Steroids/State.moarvm $(BLIB)/lib/Steroids/Animation.moarvm

all build: $(BLIB_COMPILED)

$(BLIB)/lib/Steroids.moarvm : lib/Steroids.pm $(BLIB)/lib/Steroids/SDL.moarvm $(BLIB)/lib/Steroids/State.moarvm $(BLIB)/lib/Steroids/Spritesheet.moarvm
	$(MKDIR) $(BLIB)/lib/
...
$(BLIB)/lib/Steroids/Entity.moarvm : lib/Steroids/Entity.pm
	$(MKDIR) $(BLIB)/lib/Steroids/
...
$(BLIB)/lib/Steroids/State.moarvm : lib/Steroids/State.pm $(BLIB)/lib/Steroids/SDL.moarvm $(BLIB)/lib/Steroids/Entity.moarvm $(BLIB)/lib/Steroids/Animation.moarvm
	$(MKDIR) $(BLIB)/lib/Steroids/
...
install: $(BLIB_COMPILED)
	...
	$(MKDIR) $(DESTDIR)$(PREFIX)/lib/
	$(CP) lib/Steroids.pm $(DESTDIR)$(PREFIX)/lib/
	$(MKDIR) $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(CP) lib/Steroids/SDL.pm $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(MKDIR) $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(CP) lib/Steroids/Spritesheet.pm $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(MKDIR) $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(CP) lib/Steroids/Entity.pm $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(MKDIR) $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(CP) lib/Steroids/State.pm $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(MKDIR) $(DESTDIR)$(PREFIX)/lib/Steroids/
	$(CP) lib/Steroids/Animation.pm $(DESTDIR)$(PREFIX)/lib/Steroids/
